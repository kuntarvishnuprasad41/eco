      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row justify-between gap-12">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-end gap-8">
            {/* Navigation */}
            <nav className="flex flex-col items-center lg:items-end gap-2">
        ...
        {/* Bottom Section */}
        <div className="border-t border-black/20 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
          <Link
