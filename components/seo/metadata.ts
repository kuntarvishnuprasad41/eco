...
export async function generateMetadata(locale: string): Promise<Metadata> {
  ...
  const description = isArabic
    ...
    : 'ECO Homes is a multidisciplinary firm offering architecture, landscape, and interior design services. Our goal is to create purposeful spaces that balance functionality and sustainability.'
