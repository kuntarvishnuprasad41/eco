            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="w-full border-0 border-b border-gray-300 rounded-none px-0 py-3 focus:border-green-500 focus:ring-0 placeholder:text-gray-400"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={3}
                  required
                  className="w-full border-0 border-b border-gray-300 rounded-none px-0 py-3 focus:border-green-500 focus:ring-0 resize-none placeholder:text-gray-400"
                />
              </div>
