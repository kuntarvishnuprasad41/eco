...
const properties = [
  {
    ...
    location: "Riyadh",
    image: "/sustainable-glass-villa.png",
    area: "5,500 sq.ft",
    completion: "2024",
    sustainability: "95%",
  ...
  },
  {
    ...
    category: "Commercial",
    location: "Dubai",
    image: "/curved-commercial-building.png",
    area: "45,000 sq.ft",
    completion: "2024",
    sustainability: "92%",
  ...
  },
  {
    ...
    category: "Commercial",
    location: "Jeddah",
    image: "/sustainable-office-green-walls.png",
    area: "32,000 sq.ft",
    completion: "2024",
    sustainability: "89%",
  ...
  },
  {
    ...
    category: "Residential",
    location: "Doha",
    image: "/modern-luxury-residence.png",
    area: "5,100 sq.ft",
    completion: "2025",
    sustainability: "94%",
    ...
    <div className="relative bg-white">
      ...
      <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('/modern-interior-wood-glass.png')",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto mb-8">
              Discover a curated selection of our standout projects that blend
              innovation, sustainability, and timeless beauty in every detail.
            </p>
          </div>
